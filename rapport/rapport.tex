...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\linewidth]{pie_score_severite.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\linewidth]{facteurs_severite.png}
