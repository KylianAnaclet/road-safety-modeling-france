...
Le graphique de la méthode du coude montre que la courbe se stabilise à k = 3, tandis que la silhouette présente deux maxima à k = 2 et k = 3.

Bien que le pic le plus élevé de la silhouette corresponde à k = 2, nous avons choisi k = 3 car il est cohérent avec le coude et permet une segmentation plus détaillée des observations.
